...
public class CompassView extends View implements SensorEventListener {
    ...
    public CompassView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int colorAccent = ContextCompat.getColor(getContext(), R.color.ijo);
        int colorSecondary = ContextCompat.getColor(getContext(),R.color.ijo);
    ...
    private void initPaints(int w, int h) {
        ...
        mWhiteArrowPaint.setColor(R.color.background);
    ...
    private void stopSensors() {
        Log.e( "stopSensors: ","init" );
        mSensorManager.unregisterListener(this);
        mOrientationEventListener.disable();
    }

    private void startUpdating() {
        Log.e("startUpdating: ","init" );
